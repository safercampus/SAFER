<?php  
namespace Application\Block\Reports;
...
class Controller extends BlockController {
	...
	protected $btName = 'report';
	protected $btDescription = 'Add a clickable image that will open up a report';
	protected $btTable = 'btDCReports';
	...
	public function view() {
		$this->set('field_1_image', (empty($this->field_1_image_fID) ? null : $this->get_image_object($this->field_1_image_fID, 800, 800, false)));
	}
