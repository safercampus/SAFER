<?php  
namespace Application\Block\HomepageBlurbSection;
...
class Controller extends BlockController {
	...
	protected $btName = 'Homepage Blurb Section';
	protected $btDescription = 'The homepage is made up of three Homepage Blurb Sections. Each one contains an image, a link, a blurb and button text.';
	protected $btTable = 'btDCHomepageBlurbSection';
